...
class Window(Frame):
    ...
    def ValidInscription(self):
        if self.entreeMdp.get()==self.entreeMdp2.get():
            isInUsers = False
            with open('Users.csv','r') as users:
                ...
                for line in reader:
                    if (line[0]==self.entreePseudo.get()):
                ...
                if isInUsers==False:
                    ...
                    with open('UserCourant.csv','w', newline='') as f_output: #On a joute le nouvel utilisateur a la BDD, et au fichier de l'utilisateur courant
