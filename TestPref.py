...
class Fenetre(Tk):
    def __init__(self,master=None):
        ...
        self.photo = ImageTk.PhotoImage(master=self,image= self.image2)
...
def TestPref():
    ...
    dataframe_un = pd.DataFrame(fen1.choix_de_utilisateur,columns=['like_and_dislike'])# création dataframe contenant les likes et dislikes de l'utilisateur
    dataframe_deux = pd.concat([dataframe_un , fen1.Data], axis = 1)# permet de concaténer des données
